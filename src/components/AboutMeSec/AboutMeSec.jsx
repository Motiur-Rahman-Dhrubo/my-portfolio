...
const AboutMeSec = () => {
    return (
        <div className="w-11/12 rounded-2xl mx-auto shadow-xl bg-[#F1F1F1] md:mt-10 mt-6 md:p-12 p-6">
            ...
            <div className="md:mt-6 mt-2 flex gap-4">
                ...
                <p className="md:text-2xl text-base font-medium text-justify">Hi there! I’m a junior front-end web developer with a strong passion for creating interactive and visually captivating web experiences. I enjoy learning and exploring new technologies to bring fresh ideas to life.
