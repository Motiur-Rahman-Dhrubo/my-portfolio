    ...
    return (
        <div className="w-11/12 rounded-2xl mx-auto shadow-xl md:mt-10 mt-6 lg:p-12 md:p-8 p-6">
            ...
            <div className="md:mt-6 mt-2 flex md:gap-4 gap-2 flex-wrap justify-center">
                <div className="lg:w-36 md:w-28 w-24 border p-2 rounded-lg hover:shadow-lg bg-blue-300">
                ...
                <div className="lg:w-36 md:w-28 w-24 border p-2 rounded-lg hover:shadow-lg bg-green-200">
                ...
                <div className="lg:w-36 md:w-28 w-24 border p-2 rounded-lg hover:shadow-lg bg-orange-200">
